...
# python run.py --config_path ./configs/echo_prime.yaml --save_dir path_to_dir --train
# python run.py --config_path ./configs/echo_prime.yaml --save_dir path_to_dir --evaluate
